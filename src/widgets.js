...
var u = require("uru"), _ = require("underscore");
...
function input(type){
    ...
    return {
        render: function(ctx){
            var field = ctx.field;
            return u("input",
                getWidgetAttributes(this, {value: field.value, type: type, onfocusout: this.valueChanged})
            );
        }
    };
}
...
registerWidget("checkbox", {
   render: function (ctx) {
       var field = ctx.field;
       var attrs = getWidgetAttributes(this, {checked: field.value, value: "true", type: "checkbox", onaction: this.valueChanged});
...
registerWidget("select", {
   ...
   render: function(ctx){
       ...
       var choices = _.map(field.choices, function(item){
            return u("option", {value: item.value, selected: field.getValue()}, item.label);
       });
       if(!field.required){
...
registerWidget("text", {
   render: function(ctx){
       "use strict";
       var field = ctx.field;
       var attrs = getWidgetAttributes(this, {rows: field.options.rows});
...
registerWidget("foundation-datepicker", {
   ...
   render: function(ctx){
       "use strict";
       var field = ctx.field;
       var attrs = getWidgetAttributes(this, {value: field.value, type: "text"});
...
registerWidget("multiple-checkbox", {
   ...
   render: function(ctx){
       ...
       var choices = _.map(field.choices, function(item, i){
            var id = field.id + "-" + i;
            return u("li",
                        u("input", {id: id, value: item.value, type:"checkbox", name: field.name}),
...
registerWidget("multiple-radio", {
   ...
   render: function(ctx){
       ...
       var choices = _.map(field.choices, function(item, i){
            ...
            return u("li",
                        u("label",
                            u("input", {id: id, value: item.value, type:"radio", name: field.name}),
                            item.label
                        )
            );
       });
